...
Dans l'onglet Inventaire et dans le tableau de bord, la fabrique de workloads prend en charge jusqu'à 850 bases de données au sein d'instances SQL Server.
