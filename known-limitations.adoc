...
== Intégration avec la BlueXP backup and recovery

Après avoir ajouté des hôtes à la sauvegarde et à la récupération BlueXP pour la protection, la découverte de la base de données échoue parfois.
