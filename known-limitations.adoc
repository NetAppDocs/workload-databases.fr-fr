...
* La création de sandbox n'est pas prise en charge lorsque la base de données source contient plusieurs fichiers de données répartis sur plus de 2 disques.
